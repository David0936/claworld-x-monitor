...
> **Web 2.2 已上线：** [claworld-invest-radar.vercel.app](https://claworld-invest-radar.vercel.app/news)
...
> 完整教程材料在 [`tutorial/`](tutorial/)：可翻页放映的 [index.html](tutorial/index.html)、[逐页解说稿](tutorial/narration.md)（可照读录视频）、产品真实截图。

| | |
|---|---|
| **① 这是什么** —— 解决「盯不过来、看不懂、抓不住」 | ![这是什么](tutorial/render/02-what.png) |
| **② 能干嘛** —— 监控 / AI 解读 / 股票秒筛 / 飞书推送 | ![能干嘛](tutorial/render/03-features.png) |
| **③ 怎么装** —— Mac App / 一键脚本 / 源码，三选一 | ![怎么装](tutorial/render/04-install.png) |
| **④ 配 API** —— 就填 3 个地方（数据源 / AI / 飞书） | ![配API](tutorial/render/05-config.png) |
| **⑤ 怎么用** —— 打开就能看，命中自动标红 | ![怎么用](tutorial/render/06-usage.png) |
